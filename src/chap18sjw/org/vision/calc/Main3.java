...
public class Main3 extends Application {
	...
	public void start(Stage primaryStage) {
		...
		try {
			...
			VBox root = FXMLLoader.load(getClass().getResource("calc.fxml"));
			// 장면 
			Scene scene = new Scene(root,300,170);//가로,세로 픽셀수 
